function solution(command) {
    ...
    if (totalVotes > 50) {
        let obfuscationValue = upvote > downvote ? Math.ceil(upvote * 0.25) : Math.ceil(downvote * 0.25);
        return [upvote + obfuscationValue, downvote + obfuscationValue, balance, ratingState()];
    }
